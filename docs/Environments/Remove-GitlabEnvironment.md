...
HelpUri: https://github.com/chris-peterson/pwsh-gitlab/blob/main/docs/Environments/Remove-GitlabEnvironment.md
Locale: en-US
...
```
Remove-GitlabEnvironment [[-ProjectId] <string>] [-Name] <string> [[-SiteUrl] <string>] [-WhatIf]
