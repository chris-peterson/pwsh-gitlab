...
HelpUri: https://github.com/chris-peterson/pwsh-gitlab/blob/main/docs/ServiceAccounts/Update-GitlabServiceAccount.md
Locale: en-US
...
```
Update-GitlabServiceAccount -ServiceAccountId <int> -GroupId <string> [-Name <string>]
 [-Username <string>] [-Email <string>] [-SiteUrl <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
